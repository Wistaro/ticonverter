...
var AssemblyX86HighlightRules = function() {
    ...
    this.$rules = { start: 
       [ { token: 'keyword.control.basic',
         ...
         { token: 'variable.parameter.register.basic',
           ...
           caseInsensitive: true },
         { token: 'constant.character.decimal.basic',
           regex: '\\b[0-9]+\\b' },
         { token: 'constant.character.hexadecimal.basic',
           regex: '\\b0x[A-F0-9]+\\b',
           caseInsensitive: true },
         { token: 'constant.character.hexadecimal.basic',
           regex: '\\b[A-F0-9]+h\\b',
           caseInsensitive: true },
         { token: 'string.basic', regex: /'([^\\']|\\.)*'/ },
         { token: 'string.basic', regex: /"([^\\"]|\\.)*"/ },
         { token: 'support.function.directive.basic',
           regex: '^\\[',
           push: 
            [ { token: 'support.function.directive.basic',
                regex: '\\]$',
                next: 'pop' },
              { defaultToken: 'support.function.directive.basic' } ] },
         { token: 
            [ 'support.function.directive.basic',
              'support.function.directive.basic',
              'entity.name.function.basic' ],
        ...
        { token: 
         ...
         { token: 
          ...
          { token: 'support.function.directive.basic',
           ...
           caseInsensitive: true },
         { token: 'entity.name.function.basic', regex: '^\\s*%%[\\w.]+?:$' },
         { token: 'entity.name.function.basic', regex: '^\\s*%\\$[\\w.]+?:$' },
         { token: 'entity.name.function.basic', regex: '^[\\w.]+?:' },
         { token: 'entity.name.function.basic', regex: '^[\\w.]+?\\b' },
         { token: 'comment.basic', regex: ';.*$' } ] 
    }
    
    this.normalizeRules();
};

AssemblyX86HighlightRules.metaData = { fileTypes: [ '8xp' ],
      name: 'basic',
...
var AssemblyX86HighlightRules = require("./basic_highlight_rules").AssemblyX86HighlightRules;
