...
CodeMirror.defineMode('tibasic_fr', function(_config, parserConfig) {
	...
	graph = /^(pxl-Test|EffDessin|EnrBDG|EffDess|Eff[ÉE]cran|Texte|Ligne|Line|Verticale|Pt-Aff|Pt-Naff|Pt-Change|Pxl-Aff|Pxl-Naff|Pxl-Change|Ombre|Cercle|Horizontale|Tangente|DessRecip|DessFonct|GraphStyle|AffGraph|Graph1|Graph2|Graph3|CouleurGraph|CouleurTexte|CouleurBord)\b/i;
	others = /^(Return|Lbl|Goto|DelVar|codetouch|Pause|Stop|IS>|DS<|Input|Prompt|Disp|Output|ZXscl|ZYscl|Xscl|Yscl|Xmin|Xmax|Ymin|Ymax|Tmin|Tmax|θMin|θMax|ZXmin|ZXmax|ZYmin|ZYmax|Zθmin|Zθmax|ZTmin|ZTmax|TblStart|PlotStart|ZPlotStart|nMax|ZnMax|nMin|ZnMin|∆Tbl|Tstep|θstep|ZTstep|Zθstep|∆X|∆Y|XFact|YFact|TblInput|PMT|GraphPas|ZgraphPas|Xres|ZXres|TracePas|Radian|Degré|Normal|Sci|Ing|Flottant|Rep|Fixe|Horiz|PleinEcr|Fonct|Param|Polaire|Suite|ValeursAuto|ValeursDem|CalculsAuto|CalculsDem|Séquentiel|Simul|CoordPol|CoordRect|CoordAff|CoordNAff|Relié|Thick|NonRelié|Dot\-Thick|AxesAff|AxesNAff|GridDot|QuadAff|QuadNAff|EtiqAff|EtiqNAff|Toile|uvAxes|vwAxes|uwAxes|Graph|Format|Trace|ZStandard|ZTrig|Zboîte|Zoom|Zorthonormal|ZintConf|Zprécédent|Zdécimal|ZoomStat|ZoomRpl|FonctAff|FonctNAff|Réel|ExpAff|ExpNAff|G\-T|ZminMax|CorrelAff|CorrelNAff|Manual\-Fit|ZQuadrant1|matprintbox|CLASSIC|MATHPRINT|CLASSIC|AUTO|DEC|FRAC|FRAC-APPROX|STATWIZARD|ON|STATWIZARD|OFF|LigneAff|ArrPlanAff|ArrPlanNAff|DétectAsymAct|DétectAsymDés|Fin|Point)\b/i;

	var numbers = /\d+?.?\d+_/;
	var variables = /(⌊[A-Z0-9]{1,8}|L₁|L₂|L₃|L₄|L₅|L₆|BDG[0-9]|Image[0-9]|Y₁|Y₂|Y₃|Y₄|Y₅|Y₆|Y₇|Y₈|Y₉|Y₀|X₁ᴛ|Y₁ᴛ|X₂ᴛ|Y₂ᴛ|X₃ᴛ|Y₃ᴛ|X₄ᴛ|Y₄ᴛ|X₅ᴛ|Y₅ᴛ|X₆ᴛ|Y₆ᴛ|r₁|r₂|r₃|r₄|r₅|r₆|Chn[0-9])\b/;
	var values = /(ROUGE|BLEU|NOIR|MAGENTA|VERT|ORANGE|MARRON|MRN|JAUNE|BLANC|CLR|MOY|GRIS|FON)\b/;
