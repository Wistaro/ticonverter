...
CodeMirror.defineMode('tibasic_fr', function(_config, parserConfig) {
	...
	keywords2 = /^(PrintScreen|SauveFen|SauveImage|RappelImage|SauveBDG|RappelBDG|getkey|CaptVar|EffVar|Efface|entrées|Archive|DésArchive|Asm|AsmComp|AsmPrgm|RéorganiserMém|If|Then|Else|While|Repeat|For|End|Menu|Envoi|Capt|Asm83CEPrgm|Asm84CEPrgm)\b/i;
	...
	others = /(Return|Lbl|Goto|Pause|Stop|EffEcran|IS>|DS<|Input|Prompt|Disp|Output|ZXscl|ZYscl|Xscl|Yscl|Xmin|Xmax|Ymin|Ymax|Tmin|Tmax|θMin|θMax|ZXmin|ZXmax|ZYmin|ZYmax|Zθmin|Zθmax|ZTmin|ZTmax|TblStart|PlotStart|ZPlotStart|nMax|ZnMax|nMin|ZnMin|∆Tbl|Tstep|θstep|ZTstep|Zθstep|∆X|∆Y|XFact|YFact|TblInput|PMT|GraphPas|ZgraphPas|Xres|ZXres|TracePas|Radian|Degré|Normal|Sci|Ing|Flottant|Rep|Fixe|Horiz|PleinEcr|Fonct|Param|Polaire|Suite|ValeursAuto|ValeursDem|CalculsAuto|CalculsDem|Séquentiel|Simul|CoordPol|CoordRect|CoordAff|CoordNAff|Relié|Thick|NonRelié|Dot\-Thick|AxesAff|AxesNAff|GridDot|QuadAff|QuadNAff|EtiqAff|EtiqNAff|Toile|uvAxes|vwAxes|uwAxes|Graph|Format|Trace|ZStandard|ZTrig|Zboîte|Zoom|Zorthonormal|ZintConf|Zprécédent|Zdécimal|ZoomStat|ZoomRpl|FonctAff|FonctNAff|Réel|ExpAff|ExpNAff|G\-T|ZminMax|CorrelAff|CorrelNAff|Manual\-Fit|ZQuadrant1|matprintbox|CLASSIC|MATHPRINT|CLASSIC|AUTO|DEC|FRAC|FRAC-APPROX|STATWIZARD|ON|STATWIZARD|OFF|LigneAff|ArrPlanAff|ArrPlanNAff|DétectAsymAct|DétectAsymDés|Fin|Point)\b/i;
